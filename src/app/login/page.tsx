        ...
        <div className="card p-8" style={{ background: 'var(--surface-2)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                       ...
                       className="w-full pl-9 pr-4 py-2.5 rounded-lg text-sm outline-none transition-colors focus:ring-1"
            ...
            <button type="submit" disabled={isLoading}
                    ...
                    style={{ background: isLoading ? 'var(--surface-4)' : 'var(--accent)', color: 'white', opacity: isLoading ? 0.7 : 1 }}>
